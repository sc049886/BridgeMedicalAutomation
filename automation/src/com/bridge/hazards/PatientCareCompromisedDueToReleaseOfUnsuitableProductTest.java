...
public class PatientCareCompromisedDueToReleaseOfUnsuitableProductTest 
{
	...
	String uniqueNo= commonfunctions.uniqueNumber(-1);
    String unitNo = uniqueNo; 
    String bloodOpos = "O pos";
    String bloodApos = "A pos";
    String bloodAneg = "A neg";
    String bloodBpos = "B pos";
    String yestDate = commonfunctions.currentDate("MM/dd/yyyy HH:mm",-1);
    String oldDate =  yestDate;
    String nextDate = commonfunctions.currentDate("MM/dd/yyyy HH:mm",+2);
	...
	commonfunctions.login(systemManagerUrl, username,password);
	Thread.sleep(2000);
	systeManagerMenuPage.button_TransfusionSettings().click();
	Thread.sleep(2000);
	transfusionsettingsfunctions.selectOptionForExpirationMessage(WarnContinue);
	Thread.sleep(2000);
  ...
  public void postTestSettings() throws  Throwable
  {
	  ...
	  Thread.sleep(2000);
	  commonfunctions.login(capribedsideUrl,user2, password);
	  Thread.sleep(2000);
